        ...
        <div className='flex justify-center items-center h-screen'>
            <div className="w-1/2  bg-slate-100 rounded-lg flex flex-col text-center py-5 px-20 gap-6">
                ...
                <div className="flex justify-around my-4">
                    <Link to={"/"} >
                        <button className='bg-sky-500 text-white px-5 py-2 rounded-full '>Return Home</button>
                    </Link>
                    <button className=' border border-sky-500 text-sky-500 px-5 py-2 rounded-full'>Report Problem</button>
                </div>
            </div>
        </div>
    )
