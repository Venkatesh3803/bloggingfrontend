...
const Hero = () => {
    ...
    return (
        <div className="my-10 relative overflow-hidden">
            <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:mr-5 rounded-2xl overflow-hidden">
                <img className="h-72 w-full object-cover sm:h-72 md:h-96 lg:h-full lg:w-full" src={"https://images.unsplash.com/photo-1665686304129-a6e2d16923e8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80"} alt="" />
            </div>
